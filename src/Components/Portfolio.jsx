          ...
          <div className="flex flex-col md:flex-row mt-8 gap-6 max-w-6xl w-full bg-zinc-900 border border-zinc-800 rounded-2xl p-5 text-white shadow-xl">
            ...
            <div className="w-full md:w-2/5 h-48 md:h-auto min-h-[160px] overflow-hidden rounded-xl bg-zinc-800 flex-shrink-0">
              <img
                ...
                src="/img/admin-inmobiliaria.png"
            ...
            <div className="flex flex-col justify-between flex-grow">
              <div>
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  ...
                  <span className="text-xs font-semibold tracking-wide text-zinc-300 bg-rose-600/30 border border-rose-700 px-2.5 py-1 rounded-md shadow-sm">
                    TanStack Query
                  </span>
                  ...
                  <span className="text-xs font-semibold tracking-wide text-zinc-300 bg-red-700/40 border border-red-700 px-2.5 py-1 rounded-md shadow-sm">
                    Redis
                  </span>
                  ...
                  <span className="text-xs font-semibold tracking-wide text-zinc-300 bg-indigo-600/40 border border-indigo-700 px-2.5 py-1 rounded-md shadow-sm">
                    Stripe
                  </span>
              ...
              <section className="flex flex-col sm:flex-row gap-2 mt-2">
                <a
                  href="https://admin-inmobiliaria-alpha.vercel.app/"
                  target="_blank"
                ...
                <a
                  href="https://github.com/SantyPadilla51/admin_inmobiliaria"
                  target="_blank"
                  rel="noopener noreferrer"
