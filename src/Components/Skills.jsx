  ...
  return (
    <>
      <div id="Skills" className="m-3">
        <h1 className="mt-96 text-white text-5xl uppercase font-bold">
          Skills
        </h1>
        <div>
          <h3 className="text-white mt-16 uppercase text-2xl font-bold">
            Lenguajes de Programacion | Frameworks | Librerias
          </h3>
          <ul className="text-white mt-3 flex flex-wrap gap-5">
            <li className="flex items-center gap-2 bg-yellow-500 p-2 text-black">
              {" "}
              <i className="fab fa-js icon text-2xl"></i> JavasCript
            </li>
            <li className="flex items-center gap-2 bg-blue-500 p-2 text-black">
              {" "}
              <img
            ...
            <li className="flex items-center gap-2 bg-green-600 p-2 text-black">
              {" "}
              <i className="fab fa-node-js icon text-2xl"></i> NodeJs
            </li>
            <li className="flex items-center gap-2 bg-orange-600 p-2 text-black">
              {" "}
              <i className="fab fa-html5 icon text-2xl"></i> HTML
            </li>
            <li className="flex items-center gap-2 bg-blue-600 p-2 text-black">
              {" "}
              <i className="fab fa-css3 icon text-2xl"></i> CSS
            </li>
            <li className="flex items-center gap-2 bg-blue-600 p-2 text-black">
              {" "}
              <i className="fa fa-database icon text-2xl"></i> SQL
            </li>
            <li className="flex items-center gap-2 bg-white p-1">
              <svg
                width="40px"
                height="40px"
                viewBox="0 0 24 24"
            ...
            <li className="bg-black flex items-center px-2">
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="fab"
                data-icon="github"
                class="svg-inline--fa fa-github text-3xl p-[1rem] text-white"
                role="img"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 496 512"
              >
            ...
            <li className="flex items-center gap-2 p-2 bg-green-600">
              <svg
                fill="#006f00"
                version="1.1"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <li className="flex items-center gap-2 text-black p-2 bg-blue-500">
              {" "}
              <i className="fab fa-react icon text-2xl"></i> React
            </li>
            <li className="flex items-center gap-2 text-black p-2 bg-white">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 50 50"
                width="30px"
            ...
            <li className="flex items-center gap-4 bg-white p-2">
              <svg
                fill="#2f6792"
                width="40px"
                height="40px"
