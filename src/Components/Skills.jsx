    ...
    <>
      <div id="Skills" className="mx-5 lg:mx-48 mt-64">
        ...
        <ul className="flex flex-wrap gap-3 text-zinc-200">
          {/* JavaScript */}
          <li className="flex items-center gap-2.5 bg-zinc-800/40 border border-zinc-800/80 px-4 py-2 rounded-xl hover:bg-zinc-800 hover:border-zinc-700 transition-colors duration-200 group">
            <i className="fab fa-js text-yellow-500 text-xl group-hover:scale-110 transition-transform"></i>
          ...
          {/* NodeJs */}
          <li className="flex items-center gap-2.5 bg-zinc-800/40 border border-zinc-800/80 px-4 py-2 rounded-xl hover:bg-zinc-800 hover:border-zinc-700 transition-colors duration-200 group">
            <i className="fab fa-node-js text-green-500 text-xl group-hover:scale-110 transition-transform"></i>
            <span className="text-sm font-medium">NodeJs</span>
          </li>

          {/* HTML */}
          <li className="flex items-center gap-2.5 bg-zinc-800/40 border border-zinc-800/80 px-4 py-2 rounded-xl hover:bg-zinc-800 hover:border-zinc-700 transition-colors duration-200 group">
            <i className="fab fa-html5 text-orange-500 text-xl group-hover:scale-110 transition-transform"></i>
            <span className="text-sm font-medium">HTML</span>
          </li>

          {/* CSS */}
          <li className="flex items-center gap-2.5 bg-zinc-800/40 border border-zinc-800/80 px-4 py-2 rounded-xl hover:bg-zinc-800 hover:border-zinc-700 transition-colors duration-200 group">
            <i className="fab fa-css3 text-blue-500 text-xl group-hover:scale-110 transition-transform"></i>
          ...
          <li className="flex items-center gap-2.5 bg-zinc-800/40 border border-zinc-800/80 px-3.5 py-2 rounded-xl hover:bg-zinc-800 hover:border-zinc-700 transition-colors duration-200 group">
            <svg
              className="w-5 h-5 text-zinc-100 group-hover:scale-110 transition-transform"
              role="img"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 496 512"
            >
          ...
          {/* React */}
          <li className="flex items-center gap-2.5 bg-zinc-800/40 border border-zinc-800/80 px-4 py-2 rounded-xl hover:bg-zinc-800 hover:border-zinc-700 transition-colors duration-200 group">
            <i className="fab fa-react text-cyan-400 text-xl group-hover:scale-110 transition-transform"></i>
          ...
          <li className="flex items-center gap-2.5 bg-zinc-800/40 border border-zinc-800/80 px-3.5 py-2 rounded-xl hover:bg-zinc-800 hover:border-zinc-700 transition-colors duration-200 group">
            ...
            <span className="text-sm font-medium">Postgres SQL</span>
          </li>
          ...
          <li className="flex items-center gap-2.5 bg-zinc-800/40 border border-zinc-800/80 px-3.5 py-2 rounded-xl hover:bg-zinc-800 hover:border-zinc-700 transition-colors duration-200 group">
            ...
            >
              ...
              <g>
                <path
                  d="M149.6 258.5c-6.7 8.5-20.3 3.9-20.5-6.9l-2.3-158L232.9 93.6c19.2 0 30 22.2 18 37.3L149.6 258.5z"
                  fill="url(#sb-lg-1)"
                ></path>
                <path
                  d="M149.6 258.5c-6.7 8.5-20.3 3.9-20.5-6.9l-2.3-158L232.9 93.6c19.2 0 30 22.2 18 37.3L149.6 258.5z"
                ...
                ></path>
                <path
                  d="M106.4 4.3c6.7-8.4 20.3 4.9 20.5 15.7l1 158L23 169.3c-19.2 0-30-22.2-18-37.3L106.4 4.3z"
                  fill="#3ECF8E"
                ></path>
              </g>
            </svg>
